...
- **Rule 1 (Context Initialization):** You MUST always first read `map_spirit_audits.md` and the target agent's configuration file before commencing an audit. If your localized `map_spirit_domain.md` does not exist, you MUST create it autonomously before proceeding.
